...
/// <summary>
    ...
    public class Code39
    {
      private Hashtable m_Code39 = new Hashtable();
        ...
        /// <returns>图形</returns>
        public Bitmap GetCodeImage(string p_Text, Code39Model p_Model, bool p_StarChar,string headTitle)
        {
            string _ValueText = "";
            string _CodeText = "";
            ...
            Bitmap _CodeBmp = GetImage(_CodeText,headTitle);
        ...
        /// <returns>图形</returns>
        private Bitmap GetImage(string p_Text,string title)
        {
            ...
            Font TitleFont = new Font("宋體",8,FontStyle.Regular);
            _Garphics.DrawString(title, TitleFont, Brushes.Black, 0, 0);

            _Garphics.FillRectangle(Brushes.White, new Rectangle(0, 17, _CodeImage.Width, _CodeImage.Height));
            ...
            for (int i = 0; i != _Value.Length; i++)
            {
                ...
                if (_Value[i] == '1')
                {
                    _Garphics.FillRectangle(Brushes.Black, new Rectangle(_LenEx, 17, _DrawWidth, m_Height));

                }
                else
                {
                    _Garphics.FillRectangle(Brushes.White, new Rectangle(_LenEx, 17, _DrawWidth, m_Height));
                }
                _LenEx += _DrawWidth;
            }
